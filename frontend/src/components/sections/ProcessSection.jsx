    ...
    <section style={{ padding: "7rem 5%", background: "rgba(255,255,255,0.015)", borderTop: "1px solid rgba(255,255,255,0.05)" }}>
      <div style={{ maxWidth: 1300, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "6rem", alignItems: "start" }}>
        <div>
          ...
          >
            Minh Bạch Từng<br />
            <span className="gradient-text">Bước Một</span>
          </h2>
          ...
          <div style={{ display: "flex", gap: "1rem" }}>
            ...
            >
              ...
              >
                <FiSmartphone size={18} style={{ color: "#FF6B2B" }} />
              </div>

              <p style={{ fontSize: "0.82rem", color: "#A0A0B8", lineHeight: 1.6 }}>
                Thông báo SMS/App tự động mỗi khi có cập nhật tiến độ
              </p>
            </div>
            ...
            >
              ...
              >
                <FiLock size={18} style={{ color: "#7C5CFF" }} />
              </div>

              <p style={{ fontSize: "0.82rem", color: "#A0A0B8", lineHeight: 1.6 }}>
                Không bao giờ sửa khi chưa được khách duyệt báo giá
              </p>
            </div>
          ...
          {STEPS.map((step, i) => (
            <div key={step.n} style={{ display: "flex", gap: "1.5rem", marginBottom: "2rem", position: "relative" }}>
              ...
              <div style={{
                ...
                fontFamily: "'Kanit', sans-serif", fontWeight: 800, color: "#FF6B2B", fontSize: "0.85rem",
                position: "relative", zIndex: 1,
              }}>
                {step.n}
              </div>
              <div style={{ paddingTop: "0.8rem" }}>
                <h4 style={{ fontFamily: "'Kanit', sans-serif", fontWeight: 700, fontSize: "1rem", marginBottom: "0.4rem" }}>{step.title}</h4>
